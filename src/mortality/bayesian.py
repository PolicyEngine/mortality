...
class BayesianMortalityAdjustment:
    ...
    education: Optional[Literal["high_school", "some_college", "bachelors", "graduate"]] = None
    ...
    def get_adjusted_rate(self, age: int, base_rate: Optional[float] = None) -> float:
        ...
        if self.health is not None:
            ...
            population_avg = (0.2 * health_effects["excellent"] +
        ...
        if self.education is not None:
            ...
            population_avg = (0.2 * education_effects["high_school"] +
...
def compare_approaches():
    ...
    pop_avg = (1 - smoking_prev) * non_smoker.get_adjusted_rate(age) + \
