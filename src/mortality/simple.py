...
def simulate_survival(starting_age: int,
...
def compare_genders():
    ...
    print("=" * 60)
    print(f"{'Age':<5} {'Male Rate':<12} {'Female Rate':<12} {'Male LE':<10} {'Female LE':<10}")
    print("-" * 60)
    ...
    for age in ages:
        ...
        print(f"{age:<5} {male_rate:<12.4f} {female_rate:<12.4f} {male_le:<10.1f} {female_le:<10.1f}")
