...
class SSATableFetcher:
    ...
    def fetch(self, force_refresh: bool = False) -> Tuple[Dict[int, float], Dict[int, float]]:
    ...
    def _load_cache(self, cache_file: Path) -> Tuple[Dict[int, float], Dict[int, float]]:
    ...
    def _save_cache(self, cache_file: Path, 
                   ...
                   female_rates: Dict[int, float]) -> None:
    ...
    def _get_fallback_data(self) -> Tuple[Dict[int, float], Dict[int, float]]:
        ...
        male = {
            0: 0.00598, 10: 0.00014, 20: 0.00104, 30: 0.00187,
            40: 0.00322, 50: 0.00533, 60: 0.01158, 65: 0.01604,
            70: 0.02476, 75: 0.03843, 80: 0.06069, 85: 0.09764,
            90: 0.15829, 95: 0.25457, 100: 0.40032, 110: 0.88489,
            120: 1.00000
        }
        
        female = {
            0: 0.00493, 10: 0.00011, 20: 0.00036, 30: 0.00063,
            40: 0.00128, 50: 0.00324, 60: 0.00748, 65: 0.01052,
            70: 0.01642, 75: 0.02653, 80: 0.04365, 85: 0.07247,
            90: 0.11991, 95: 0.19620, 100: 0.31467, 110: 0.72299,
            120: 1.00000
        }
...
def fetch_ssa_table(force_refresh: bool = False) -> Tuple[Dict[int, float], Dict[int, float]]:
